...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        match self {
            Error::InvalidResponse(err) => write!(f, "InvalidResponse: Did not receive valid HTTP response from {}", err.request.url),
            ...
            Error::NoRead(err) => write!(f, "Unable to read from server at URL {}, server error: {}", err.request.url, err.response),
